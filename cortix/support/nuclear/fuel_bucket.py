...
class FuelBucket:
    ...
    cladding_wall_thickness = property(get_cladding_wall_thickness, None, None, None)
    ...
    def __get_inner_slug_fresh_u_mass(self):
        ...
        return float(self.__specs.loc["U mass inner slug [kg]", 1]) * 1000.0  # [g]
    ...
    def __get_outer_slug_cladding_mass(self):
        ...
        return (
            float(self.__specs.loc["Cladding mass outer slug [kg]", 1]) * 1000.0
        )  # [g]
    ...
    def __get_inner_slug_cladding_mass(self):
        ...
        return (
            float(self.__specs.loc["Cladding mass inner slug [kg]", 1]) * 1000.0
        )  # [g]
    ...
    def __get_cladding_wall_thickness(self):
        ...
        return float(self.__specs.loc["Cladding wall thickness [mm]", 1]) / 10.0  # cm
    ...
    def __get_cladding_end_thickness(self):
        ...
        return (
            float(self.__specs.loc["Cladding end cap thickness [mm]", 1]) / 10.0
        )  # cm
