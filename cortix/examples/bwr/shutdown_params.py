...
def shutdown_params():
    ...
    params['q_0'] = 0.1
	params['fuel macro a'] = 1.34226126162 #fuel macroscopic absorption cross section, cm^-1  params['mod micro a'] = 0.332 * unit.zepto * unit.milli #moderator microscopic absorption cross section, cm^2
