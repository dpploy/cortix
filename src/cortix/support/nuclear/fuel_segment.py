...
class FuelSegment:
    ...
    def __init__(self, geometry=pandas.Series(), species=list()):
    ...
    def get_attribute(self, name, nuclide=None, series=None):
        ...
        if nuclide is None and series is None:
            ...
            if (
                attribute_name == "mass-cc"
                or attribute_name == "mass-dens"
                or attribute_name == "mass"
            ):
                mass_cc = 0.0
            ...
            # radioactivity
            if (
                attribute_name == "radioactivtyDens"
                or attribute_name == "radioactivity"
            ):
                radDens = 0.0
                for spc in self.__species:
        ...
        if (
            attribute_name == "thermalDens"
            or attribute_name == "thermal"
            or attribute_name == "heat-dens"
            or attribute_name == "heat"
        ):
            assert False
                    ...
                    for item in formula:
                        if len(item.split("*")) == 1:  # no multiplier (implies 1.0)
                            ...
                            if item.split("*")[1].strip() == nuclide:
                                mole_fraction = float(item.split("*")[0].strip())
                            else:
                                mole_fraction = 0.0
                    ...
                    for item in formula:
                        ...
                        if len(item.split("*")) == 1:  # no multiplier (implies 1.0)
                            ...
                            formula_nuclide_molar_mass = (
                                ELEMENTS[formula_nuclide_symbol]
                                .isotopes[formula_nuclide_mass_number]
                                .mass
                            )
                            ...
                            formula_nuclide_molar_mass = (
                                ELEMENTS[formula_nuclides_symbol]
                                .isotopes[formula_nuclide_mass_number]
                                .mass
                            )
                        ...
                        mass_cc += (
                            spc.molarCC * mole_fraction * formula_nuclide_molar_mass
                        )
