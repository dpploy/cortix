...
class FuelSegmentsGroups:
    ...
    def __init__(self, key=None, fuelSegments=None):
        # constructor
    ...
    def GetAttribute(
        self, groupKey=None, attributeName=None, nuclideSymbol=None, nuclideSeries=None
    ):
        """
    ...
    def __GetGroupAttribute(
        self, groupKey=None, attributeName=None, symbol=None, series=None
    ):
        """
        ...
        # Get average property in all fuel segments within a groupKey
            ...
            for fuelSegment in fuelSegments:
                attribute += fuelSegment.get_attribute(attributeName, symbol, series)
    ...
    def __RemoveFuelSegment(self, groupKey, fuelSegment_remove):
        ...
        for fuelSegment in fuelSegments:
            if fuelSegment.get_attribute(
                "segmentId"
            ) == fuelSegment_remove.get_attribute("segmentId"):
