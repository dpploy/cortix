...
# passed into/out of the function are immutable.
    ...
    def ReduceCladdingVolume(self, dissolvedVolume):
        #removes the specified volume of cladding from the fluel slug. This will update attribute data (inner and outer diameters, cladding wall thickness, cladding cap thickness and fuel slug length), as well as cladding phase data (mass, volume and densitu).
