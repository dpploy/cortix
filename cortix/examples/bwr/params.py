...
def get_params():
    ...
    params['buckling'] = (math.pi/237.5)**2.0 + (2.405/410)**2.0
    params['q_0'] = 5000
    # fuel macroscopic absorption cross section, cm^-1
    params['fuel macro a'] = 1.34226126162
    # moderator microscopic absorption cross section, cm^2
    params['mod micro a'] = 0.332 * unit.zepto * unit.milli
    #number density of the fuel, atoms/cm^3
    params['n fuel'] = 1.9577906e+21
    #resonance integral, I (dimensionless)
    params['I'] = 40.9870483 * unit.zepto * unit.milli
    # moderator microscopic scattering cross section, cm^2
    params['mod micro s'] = 20 * unit.zepto * unit.milli
    ...
    params['heat transfer area'] = 25000 #m2, or 500 4m long, 0.1m diameter pipes
    ...
    params['fis_prod_beta_energy_rate'] = 1.26 * 1.602e-13
    # J/(fission sec) 1.40 t^-1.2 (t in seconds)
    params['fis_prod_alpha_energy_rate'] = 1.40 * 1.602e-13
