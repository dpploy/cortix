...
class FuelBundle:
    ...
    def __init__(self, specs=pandas.DataFrame()):
    ...
    def get_radioactivity(self):
        ...
        return self.__solid_phase.GetValue("radioactivity") + self.__gas_phase.GetValue(
            "radioactivity"
        )
    ...
    def get_gamma_pwr(self):
        ...
        return self.__solid_phase.GetValue("gamma") + self.__gas_phase.GetValue("gamma")
    ...
    def get_heat_pwr(self):
        ...
        return self.__solid_phase.GetValue("heat") + self.__gas_phase.GetValue("heat")
    ...
    def __get_fresh_u_mass(self):
        ...
        return float(self.__specs.loc["U mass per assy [kg]", 1]) * 1000.0  # [g]
    ...
    def __get_fuel_pin_length(self):
        ...
        return float(self.__specs.loc["Fuel rods fuel length [in]", 1]) * 2.54  # cm
    ...
    def __get_fuel_rod_wall_thickness(self):
        ...
        return float(self.__specs.loc["Fuel rods wall thickness [in]", 1]) * 2.54  # cm
