...
class Specie:
    ...
    molarRadioactivity = property(
        GetMolarRadioactivity, SetMolarRadioactivity, None, None
    )
    ...
    molarRadioactivityFractions = property(
        GetMolarRadioactivityFractions, SetMolarRadioactivityFractions, None, None
    )
    ...
    molarRadioactivityUnit = property(
        GetMolarRadioactivityUnit, SetMolarRadioactivityUnit, None, None
    )
    ...
    def __str__(self):
        ...
        return s % (
            ...
            self.massCCUnit,
            self.flag,
            self.molarRadioactivity,
            self.molarRadioactivityUnit,
            self.molarRadioactivity * self.molarCC,
            "[Ci/cc]",
            self.molarHeatPwr,
            self.molarHeatPwrUnit,
            self.molarHeatPwr * self.molarCC,
            "[W/cc]",
            self.molarGammaPwr,
            self.molarGammaPwrUnit,
            self.molarGammaPwr * self.molarCC,
            "[W/cc]",
