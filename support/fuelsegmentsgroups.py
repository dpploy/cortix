...
# passed into/out of the function are immutable.
 ...
 def GetAttribute(self, groupKey=None, attributeName=None, 
     ...
     return self.__GetGroupAttribute( groupKey, attributeName, nuclideSymbol, nuclideSeries )
...
#---------------------------------------------------------------------------------
 def __GetGroupAttribute(self, groupKey=None, attributeName=None, symbol=None, series=None ):
